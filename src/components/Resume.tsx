    ...
    return (
        <div className="resume-container">
            <div className="btn-resume" onClick={() => setOpen(!open)}>
                <svg className='resume-icon3' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20">
                    <g fill="none">
                        ...
                        <path
                            ...
                            clip-rule="evenodd"
                        />
                        <path className='stroke-cv' stroke="#fff" stroke-linecap="round" stroke-linejoin="round" d="M11.5 2.1v4.7h4.7" stroke-width="1" />
            ...
            <div className={`resumes ${open ? 'open' : ''}`}>
                <a href={translations?.navbar?.cvUrl} target="_blank" rel="noopener noreferrer" className="resume">
                    <svg className='resume-icon' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
